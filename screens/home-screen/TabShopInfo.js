  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.inputRow}>
        ...
        <Text style={styles.input}>SampleUsername</Text>
      </View>
      <View style={styles.inputRow}>
        <Text style={styles.label}>ชื่อร้าน:</Text>
        <Text style={styles.input}>SampleShopName</Text>
      </View>
      <View style={styles.inputRow}>
        <Text style={styles.label}>เบอร์โทรศัพท์:</Text>
        <Text style={styles.input}>SamplePhoneNumber</Text>
      </View>
      <View style={styles.inputRow}>
        <Text style={styles.label}>โรงอาหาร:</Text>
        <Text style={styles.input}>SampleCanteen</Text>
      </View>
      <View style={styles.inputRow}>
        <Text style={styles.label}>หมายเลขร้าน:</Text>
        <Text style={styles.input}>SampleShopNumber</Text>
      </View>
